...
public class Training implements Serializable {
    ...
    public Training(int walkBeforeTime, int walkAfterTime, ArrayList<RunBlock> runBlocks) {
    ...
    public static Training getTraining(String runString) {
        int walkBefore = 0;
        int walkAfter = 0;
        ...
        return new Training(walkBefore, walkAfter, runBlocks);
    }
}
